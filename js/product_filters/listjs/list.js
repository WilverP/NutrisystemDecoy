...
/***/ "./resources/js/product_filters/listjs/list.js":
/*!*****************************************************!*\
  !*** ./resources/js/product_filters/listjs/list.js ***!
  \*****************************************************/
  ...
  8: [function (require, module, exports) {
    var Templater = function Templater(list) {
      ...
      this.get = function (item, valueNames) {
        /* POWERREVIEWS CODE TO SKIP CREATING DATA-ID, DATA */
        if (item.elm.localName == 'script') {
          return;
        }
        /* POWERREVIEWS CODE TO RENDER - START */
  ...
  15: [function (require, module, exports) {
    ...
    module.exports = function (a, b, opts) {
      ...
      xD = parseInt(x.match(hre), 16) || xN.length !== 1 && Date.parse(x),
        ...
        //We were getting s as undefined when the product list contails 2 products with simillar naming structure.
...
/******/ 	var __webpack_exports__ = __webpack_require__("./resources/js/product_filters/listjs/list.js");
/******/ 	
/******/ })()
;